...
/**
 * The LoseController class is responsible for controlling the "lose" screen of the application. It
...
public class LoseController {
   ...
   *
   * <p>This method is called when the user clicks the main menu button on the "lose" screen. It
